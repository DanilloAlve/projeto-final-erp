...
export class AuthService {
  ...
  private mapFuncaoToPerfil(funcao: string): Perfil {
    const perfil = funcao?.trim().toUpperCase();
  ...
  async register(user: User, password: string): Promise<{ success: boolean; message?: string }> {
    try {
